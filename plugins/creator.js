...
let handler = async(m, { conn }) => {
    ...
    orderTitle: ``,
    thumbnail: await (await fetch('https://telegra.ph/file/e474a4e78854b29544f3e.jpg')).buffer(), //Gambarnye
	...
	conn.p[id] = [
	await conn.sendKontak(m.chat, kontak, ftroli, { contextInfo: { externalAdReply :{ 
  ...
  return conn.sendButtonDoc(m.chat, `Hay kak @${await m.sender.split('@')[0]}, itu nomor ownerku jangan dispam yah ^_^`, 'Itu Owner Ku Yah Kak Jangan Sungkem Untuk Chat ;3','Credits', '.tqto', m, { quoted: conn.p[id][0],
    contextInfo: { //forwardingScore: 99999, isForwarded: true,
        externalAdReply: { //showAdAttribution: true,
            ...
            title: 'Jangan dibully Dia Kang Kopas <3',
            body: 'Follow Tiktok owner kak :v',
