...
Seluruh informasi kamu (no. handphone, alamat email, dan password) adalah rahasia. Jangan pernah berikan informasi tersebut kepada siapa pun. yukino Bot tidak pernah meminta informasi rahasia dari kamu.
...
*Supported By @${global.owner[0].split('@')[0]}*` 
 ...
    aww = await conn.sendButtonLoc(m.sender, 'https://telegra.ph/file/264041d94248b191f4c13.jpg', `Welcome to Yukino Bot ! Please confirm your account using the following code:
