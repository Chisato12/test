let fs = require('fs') 
 ...
         this.sendTemplate2ButtonLoc(m.chat, 'https://telegra.ph/file/de1678007a368fe66c052.jpg', `┌「 *Undang Bot ke Grup* 」 
 ├ 7 Hari / Rp 5,000 
 ├ 30 Hari / Rp 15,000 
 └──── 
 ...
        await this.setBio(`⏲️ Runtime: ${uptime} | 🛰 Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} |🌱 by Ray San`).catch(_ => _)  
